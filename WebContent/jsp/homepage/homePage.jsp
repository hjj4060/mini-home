			...
			<div class="container">
				...
				<center>
					...
					<c:if test="${homePage.photoGallaryUseYn}">
						<a onclick="photoGall()" class="btn btn-primary">포토 갤러리</a>
					</c:if>
					<c:if test="${homePage.guestBookUseYn}">
						<a href="" class="btn btn-primary">방명록</a>
					</c:if>
					<c:if test="${homePage.diaryUseYn}">
						<a onclick="diary()" class="btn btn-primary">다이어리</a>
					</c:if>
					<c:if test="${homePage.fileGallaryUseYn}">
						<a onclick="fileGall()" class="btn btn-primary">파일 갤러리</a>
					</c:if>
