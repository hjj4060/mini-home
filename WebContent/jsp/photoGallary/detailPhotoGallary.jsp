			...
			<div class="container">
				<center>
					<p class="h1">사진첩 상세</p>
						...
						<a href="${pageContext.request.contextPath}/jsp/photogallary/listphotogallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}">목록</a>
						...
						<a href="${pageContext.request.contextPath}/jsp/photogallary/deletephotogallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}&no=${board.no}">삭제</a>
						<br>
						...
						<table>
							...
							<c:forEach var = "s" items="${commentList}" varStatus="loop">
								<tr>
									...
									<c:choose>
										<c:when test="${commentNo != s.commentNo}">
											<td><a href="${pageContext.request.contextPath}/jsp/photogallary/detailphotogallary
											?homepage_no=${homepage_no}
											&category_group_no=${category_group_no}
											&category_no=${category_no}
											&no=${s.no}
									...
									<td><a href="${pageContext.request.contextPath}/jsp/photogallary/deletecomment
									?homepage_no=${homepage_no}
									&category_group_no=${category_group_no}
									&category_no=${category_no}
									&no=${board.no}
