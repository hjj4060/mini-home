			...
			<div class="container">
				<center>
					<p class="h1">자료실 상세</p>
							...
							<tr align="left" colspan="2">
								<td>
									<c:if test="${likeCheck == 0 && hateCheck == 0}">
										<a href="${pageContext.request.contextPath}/jsp/vote/votelikeboard
								...
								<td>
									<c:if test="${hateCheck == 0 && likeCheck == 0}">
										<a href="${pageContext.request.contextPath}/jsp/vote/votehateboard
										?homepage_no=${homepage_no}
										&category_group_no=${category_group_no}
										&category_no=${category_no}
										&no=${board.no}
						...
						<a href="${pageContext.request.contextPath}/jsp/filegallary/listfilegallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}">목록</a>
						<a href="${pageContext.request.contextPath}/jsp/filegallary/modifyformfilegallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}&no=${board.no}">수정</a>
						<a href="${pageContext.request.contextPath}/jsp/filegallary/deletefilegallary?homepage_no=${homepage_no}&category_group_no=${category_group_no}&category_no=${category_no}&no=${board.no}">삭제</a>
						<br>
						...
						<table>
							...
							<c:forEach var = "s" items="${commentList}" varStatus="loop">
								<tr>
									...
									<c:choose>
										<c:when test="${commentNo != s.commentNo}">
											<td><a href="${pageContext.request.contextPath}/jsp/filegallary/detailfilegallary
											?homepage_no=${homepage_no}
											&category_group_no=${category_group_no}
											&category_no=${category_no}
											&no=${s.no}
									...
									<td><a href="${pageContext.request.contextPath}/jsp/filegallary/deletecomment
									?homepage_no=${homepage_no}
									&category_group_no=${category_group_no}
									&category_no=${category_no}
									&no=${board.no}
