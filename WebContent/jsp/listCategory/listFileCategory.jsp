			...
			<div class="container">
				<center>
					...
					<c:forEach var = "s" items="${list}" varStatus="loop">
						<tr>
							<td><a href="${pageContext.request.contextPath}/jsp/filegallary/listfilegallary?homepage_no=${s.homepageNo}&category_group_no=${s.categoryGroupNo}&category_no=${s.categoryNo}">${s.name}</a></td>
						</tr>
					</c:forEach>
